...
import be.sanderdecleer.dndapp.FeatureAdapter;
...
public class CharacterSheet extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Create adapter and link to view
        FeatureAdapter adapter = new FeatureAdapter(this, R.layout.p_ability_view_item);
        ListView abilitiesView = (ListView) findViewById(R.id.feature_list);
        if (abilitiesView != null)
            abilitiesView.setAdapter(adapter);
...
//        }
    ...
    public void setActiveCharacter(CharacterModel character) {
        ...
        // Update other stats
        String formattedAC = String.format(getResources().getString(R.string.character_AC), activeCharacter.AC);
        ((TextView) findViewById(R.id.character_AC)).setText(formattedAC);

        String formattedHP = String.format(getResources().getString(R.string.character_HP), activeCharacter.HP);
        ...
        // Update the feature adapter
        ListView abilitiesView = (ListView) findViewById(R.id.feature_list);
        FeatureAdapter adapter = (FeatureAdapter) abilitiesView.getAdapter();
